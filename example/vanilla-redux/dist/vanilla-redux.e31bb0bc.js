...
var divToggle = document.querySelector(".toggle"); //const divToggle = document.getElementsByClassName("toggle");

var counter = document.querySelector("h1");
var btnIncrease = document.querySelector("#increase");
var btnDecrease = document.querySelector("#decrease"); //엑션 타입 정의

var TOGGLE_SWITCH = "TOGGLE_SWITCH";
var INCREASE = "INCREASE";
var DECREASE = "DECREASE"; //엑션 생성 함수

var toggleSwitch = function toggleSwitch() {
  return {
    type: TOGGLE_SWITCH
  };
}; //객체 리터럴 표현하기 위해 함수 본문을 괄호 속에넣는다.
...
var store = (0, _redux.createStore)(reducer); //파라미터에 리듀서 함수 넣어주기
...
render(); //엑션이 발생하여 스토어 상태 바뀔때마다 업데이트 됨
...
},{"redux":"node_modules/redux/es/redux.js"}],"C:/Users/user/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
