//웹팩 환경 설정 파일
//빌드할 때 어떤 파일에서 시작되어 파일들을 불러오는지, 어디에 결과물을 저장할지 정해줌
const paths = require("./paths");
const getCSSModuleLocalIdent = require("react-dev-utils/getCSSModuleLocalIdent"); // CSS Module의 고유 className을 만들 때 필요한 옵션
const nodeExtranls = require("webpack-node-externals"); //서버를 위해 번들링 할 때, node_modules를 제외하고 번들링하는 라이브러리
const webpack = require("webpack"); // 환경변수 설정하기 위함
const getClientEnviroment = require("./env"); // 환경변수 설정하기 위함
